    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          PI = _float(Math.PI);
          sqrt2PI = sqrt$1(PI.mul(2));
          sq = function sq(x) {
            return x.mul(x);
          };
          hav = function hav(x) {
            return sq(sin$1(x.div(2)));
          };
          ...
          gaussianKernel = function gaussianKernel(x, bw) {
            return exp$1(negate$1(sq(x.div(bw)).div(2))).div(bw.mul(sqrt2PI));
          };
          ...
          computeShaderFn = Fn$1(function () {
            ...
            var res = sRes.element(instanceIndex$1);
            res.assign(0);
