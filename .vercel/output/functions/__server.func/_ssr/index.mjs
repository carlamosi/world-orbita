...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import('../_tanstack-start-manifest_v-DgH6uh3N.mjs');
...
const manifest = {
  '53c64cca3646c2b4aaf504a141a3d2042fd2449c1c0271acd3f45828b2e21f01': {
    functionName: '_syncPush_createServerFn_handler',
    importer: () => import('./sync.functions-DOaS-xkH.mjs')
  },
  '605045233debcf4fbca7c93f06a21eab51d31e90e5fab3208ca6233b08e8f1d1': {
    functionName: 'deleteAccount_createServerFn_handler',
    importer: () => import('./account.functions-drjmhNX2.mjs')
  },
  'a47e3e26109e8d69cb5b2ed73ab22d2a9aaa221b5b9490a11286d7e99f779006': {
    functionName: '_syncPull_createServerFn_handler',
    importer: () => import('./sync.functions-DOaS-xkH.mjs')
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import('./router-T2jDQtma.mjs').then(n => n.r),
    import('./start-Bc2AhZBc.mjs'),
...
export { TSS_SERVER_FUNCTION as T, createServerFn as a, getRequest as b, createMiddleware as c, createServerEntry, server as default, getServerFnById as g };
