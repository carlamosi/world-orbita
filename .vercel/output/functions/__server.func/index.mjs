...
const _lazy_7tC3CZ = defineLazyEventHandler(() => import('./_chunks/ssr-renderer.mjs'));

const findRoute = /* @__PURE__ */ (() => {const data={route:"/**",handler:_lazy_7tC3CZ};return ((_m, p)=>{return {data,params:{"_":p.slice(1)}};})})();
